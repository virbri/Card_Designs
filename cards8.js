...
$(document).ready(function() {
    ...
    ///===================================================
      ...
      $('#open').on('click', async function() {
        ...
        number = 1;
    // Card 05
    $(".card05 .back").delay(1400).queue(function(nxt) {
        $(this).show();
        $(".card05 .back").css("background-image", "url('https://raw.githubusercontent.com/virbri/Card_Designs/main/card_back_small.png')");
        document.getElementById('glowing5').style.visibility = 'visible';
        this.className += ' animIn';
        // Card 05
        $(".card05 .back").delay(1600).queue(function(nxt) {
    ...
    // Card 04
    $(".card04 .back").delay(1600).queue(function(nxt) {
    $(this).show();
    $(".card04 .back").css("background-image", "url('https://raw.githubusercontent.com/virbri/Card_Designs/main/card_back_small.png')");
    document.getElementById('glowing4').style.visibility = 'visible';
    this.className += ' animIn';
    // Card 04
    $(".card04 .back").delay(1900).queue(function(nxt) {
        this.className += ' shake';
        nxt();
    });
    $(this).click(function() {
    ...
    // Card 03
    $(".card03 .back").delay(1900).queue(function(nxt) {
    $(this).show();
    $(".card03 .back").css("background-image", "url('https://raw.githubusercontent.com/virbri/Card_Designs/main/card_back_small.png')");
    document.getElementById('glowing3').style.visibility = 'visible';
    this.className += ' animIn';
    // Card 03
    $(".card03 .back").delay(2200).queue(function(nxt) {
        this.className += ' shake';
        nxt();
    });
    $(this).click(function() {
    ...
    nxt();
        ...
        // Card 02
        $(".card02 .back").delay(2400).queue(function(nxt) {
            $(this).show();
            $(".card02 .back").css("background-image", "url('https://raw.githubusercontent.com/virbri/Card_Designs/main/card_back_small.png')");
            document.getElementById('glowing2').style.visibility = 'visible';
            this.className += ' animIn';
            // Card 02
            $(".card02 .back").delay(2700).queue(function(nxt) {
                this.className += ' shake';
                nxt();
            });   
            $(this).click(function() {
          ...
          // Card 01
          $(".card01 .back").delay(2700).queue(function(nxt) {
            $(".card01").css("pointer-events", "auto");
            $(this).show();
            $(".card01 .back").css("background-image", "url('https://raw.githubusercontent.com/virbri/Card_Designs/main/card_back_small.png')");
            document.getElementById('glowing1').style.visibility = 'visible';
            this.className += ' animIn';
            // Card 02
            $(".card01 .back").delay(2500).queue(function(nxt) {
                this.className += ' shake';
                nxt();
            });   
            $(this).click(function() {
        ...
        $(myButton).delay(6000).queue(function(nxt) {
        ...
        // get a random rarity (would be better to use weighted random selection algorithm)
        // https://stackoverflow.com/questions/43566019/how-to-choose-a-weighted-random-array-element-in-javascript
        // https://stackoverflow.com/questions/56061089/picking-array-values-using-probability
        // function getRandomRarity() {
        //   var rarityArray = ['common', 'uncommon', 'rare', 'elite'];
        //   var randomRarity = Math.floor(Math.random() * rarityArray.length);
        //   return rarityArray[randomRarity];
        // }
...
function resetCanvas() {
    ...
    // redraw any initial content onto the canvas
    let frame = spriteSheet.frames[0].frame;
